...
### 7.4 生成头像视频（Wan2.6-I2V-Flash）

- `POST /api/avatar/video/generate?scope=account|user`
...
```json
{
  "imageUrl": "/files/1700000000000_avatar.png",
  "introText": "我是小明，喜欢数学和英语。",
  "prompt": "让角色做微笑和挥手动作。",
  "resolution": "720P",
  "duration": 10,
  "shotType": "multi"
...
- `GET /api/avatar/video/status?jobId=...&scope=account|user`
